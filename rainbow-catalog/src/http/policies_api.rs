...
async fn handle_get_catalog_policies(Path(catalog_id): Path<Uuid>) -> impl IntoResponse {
...
async fn handle_get_dataset_policies(Path(dataset_id): Path<Uuid>) -> impl IntoResponse {
...
async fn handle_get_dataservices_policies(Path(dataservice_id): Path<Uuid>) -> impl IntoResponse {
    info!(
...
async fn handle_get_distributions_policies(Path(distribution_id): Path<Uuid>) -> impl IntoResponse {
    info!(
