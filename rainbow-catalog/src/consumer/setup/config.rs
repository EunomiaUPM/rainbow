...
pub struct CatalogBypassConsumerApplicationConfig {
...
impl Default for CatalogBypassConsumerApplicationConfig {
    fn default() -> Self {
        CatalogBypassConsumerApplicationConfig::from(ApplicationConsumerConfig::default())
    }
}

impl ApplicationConsumerConfigTrait for CatalogBypassConsumerApplicationConfig {
        ...
        Self: Sized,
    {
        ...
        CatalogBypassConsumerApplicationConfig::from(app_config)
    }
}

impl From<ApplicationConsumerConfig> for CatalogBypassConsumerApplicationConfig {
...
impl Into<ApplicationConsumerConfig> for CatalogBypassConsumerApplicationConfig {
