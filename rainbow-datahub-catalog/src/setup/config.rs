...
pub struct DatahubCatalogApplicationProviderConfig {
...
impl Default for DatahubCatalogApplicationProviderConfig {
    fn default() -> Self {
        DatahubCatalogApplicationProviderConfig::from(ApplicationProviderConfig::default())
    }
}

impl ApplicationProviderConfigTrait for DatahubCatalogApplicationProviderConfig {
...
impl From<ApplicationProviderConfig> for DatahubCatalogApplicationProviderConfig {
...
impl Into<ApplicationProviderConfig> for DatahubCatalogApplicationProviderConfig {
