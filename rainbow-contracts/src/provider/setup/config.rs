...
impl<'a> Default for ContractNegotiationProviderApplicationConfig<'a> {
    fn default() -> Self {
        ContractNegotiationProviderApplicationConfig {
            ...
            database_config: DatabaseConfig {
                ...
                url: "127.0.0.1",
                port: "5436",
                user: "ds_cn_provider_db",
                password: "ds_cn_provider_db",
                name: "ds_cn_provider_db",
            },
...
impl<'a> ContractNegotiationProviderApplicationConfig<'a> {
