...
pub enum DSRPCContractNegotiationProviderErrors {
    ...
    ConsumerNotReachable { provider_pid: Option<Urn>, consumer_pid: Option<Urn> },
    #[error("Consumer internal error")]
    ConsumerInternalError { provider_pid: Option<Urn>, consumer_pid: Option<Urn>, consumer_error: Value },
    #[error("Consumer response is not protocol compliant")]
    ConsumerResponseNotSerializable { provider_pid: Option<Urn>, consumer_pid: Option<Urn> },
