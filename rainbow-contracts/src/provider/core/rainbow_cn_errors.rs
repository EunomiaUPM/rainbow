...
pub struct CnErrorProviderErrorOut {
    pub error: CnErrorProviderOutDetail,
}
#[derive(Serialize, Deserialize, Debug)]
pub struct CnErrorProviderOutDetail {
    pub code: String,
    pub title: String,
    pub message: String,
}

impl CnErrorProviderErrorOut {
    pub fn new(code: String, title: String, message: String) -> Self {
        CnErrorProviderErrorOut { error: CnErrorProviderOutDetail { code, title, message } }
    }
}
