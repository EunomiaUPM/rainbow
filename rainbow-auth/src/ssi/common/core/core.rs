...
use crate::ssi::common::core::traits::{
    AuthCoreTrait, CoreBusinessTrait, CoreGaiaSelfIssuerTrait, CoreGateKeeperTrait, CoreMateTrait, CoreOnboarderTrait,
    CoreVcRequesterTrait, CoreVerifierTrait, CoreWalletTrait,
};
use crate::ssi::common::services::business::BusinessTrait;
use crate::ssi::common::services::callback::CallbackTrait;
use crate::ssi::common::services::gaia_self_issuer::GaiaSelfIssuerTrait;
use crate::ssi::common::services::gatekeeper::GateKeeperTrait;
use crate::ssi::common::services::onboarder::OnboarderTrait;
use crate::ssi::common::services::repo::repo_trait::AuthRepoTrait;
use crate::ssi::common::services::vc_requester::VcRequesterTrait;
use crate::ssi::common::services::verifier::VerifierTrait;
...
pub struct AuthCore {
    wallet: Option<Arc<dyn WalletServiceTrait>>,
...
impl CoreGaiaSelfIssuerTrait for AuthCore {
    fn self_issuer(&self) -> Arc<dyn GaiaSelfIssuerTrait> {
        let self_issuer = self.self_issuer.clone().or_else(|| {
            let error = CommonErrors::module_new("Wallet");
            error!("{}", error.log());
            None
        });
