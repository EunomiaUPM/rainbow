        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(NegotiationAgentIdentifiers::Id).string().not_null().primary_key())
                    .col(ColumnDef::new(NegotiationAgentIdentifiers::NegotiationAgentProcessId).string().not_null())
