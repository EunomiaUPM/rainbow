...
export const getBusinessDatahubCatalogsOptions = (api_gateway: string) => queryOptions({
...
export const useBusinessGetDatahubCatalogs = () => {
    ...
    const {data, isLoading, isError, error} = useSuspenseQuery(getBusinessDatahubCatalogsOptions(api_gateway))
...
export const getBusinessDatahubDatasetsByCatalogIdptions = (api_gateway: string, urn: string) => queryOptions({
...
export const useGetBusinessDatahubDatasetsByCatalogId = (urn: string) => {
    ...
    const {
        ...
        isError,
        error
    } = useSuspenseQuery(getBusinessDatahubDatasetsByCatalogIdptions(api_gateway, urn))
    return {data, isLoading, isError, error}
}
...
export const getBusinessDatahubDatasetOptions = (api_gateway: string, datasetId: string) => queryOptions({
...
export const useGetBusinessDatahubDataset = (datasetId: string) => {
    const {api_gateway} = useContext<GlobalInfoContextType>(GlobalInfoContext);
    const {data, isLoading, isError, error} = useSuspenseQuery(getBusinessDatahubDatasetOptions(api_gateway, datasetId))
    return {data, isLoading, isError, error}
}
 ...
 * */
export const getBusinessPoliciesByDatasetId = async (api_gateway: string, catalogId: UUID, datasetId: UUID) => {
...
export const getBusinessPoliciesByDatasetIdOptions = (api_gateway: string, catalogId: UUID, datasetId: UUID) => queryOptions({
...
export const useBusinessGetPoliciesByDatasetId = (catalogId: UUID, datasetId: UUID) => {
    ...
    const {
        ...
        isError,
        error
    } = useSuspenseQuery(getBusinessPoliciesByDatasetIdOptions(api_gateway, catalogId, datasetId))
    return {data, isLoading, isError, error}
}
...
export const getBusinessPolicyTemplatesOptions = (api_gateway: string) => queryOptions({
