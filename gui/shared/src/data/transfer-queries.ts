...
export const getTransferProcesses = async (api_gateway: string) => {
    const catalog: TransferProcess[] = await (
        await fetch(api_gateway + `/transfers`)
    ).json();
    return catalog;
}

export const getTransferProcessesOptions = (api_gateway: string) => queryOptions({
...
export const useGetTransferProcesses = () => {
    ...
    const {data, isLoading, isError, error} = useSuspenseQuery(getTransferProcessesOptions(api_gateway))
 ...
 * */
export const getTransferProcessByProviderPid = async (api_gateway: string, transferProcessId: UUID) => {
    const catalog: TransferProcess = await (
...
export const getTransferProcessByProviderPidOptions = (api_gateway: string, transferProcessId: UUID) => queryOptions({
...
export const useGetTransferProcessByProviderPid = (transferProcessId: UUID) => {
    ...
    const {
        ...
        isError,
        error
    } = useSuspenseQuery(getTransferProcessByProviderPidOptions(api_gateway, transferProcessId))
    return {data, isLoading, isError, error}
}
 ...
 * */
export const getTransferMessagesByProviderPid = async (api_gateway: string, transferProcessId: UUID) => {
...
export const getTransferMessagesByProviderPidOptions = (api_gateway: string, transferProcessId: UUID) => queryOptions({
...
export const useGetTransferMessagesByProviderPid = (transferProcessId: UUID) => {
    ...
    const {
        ...
        isError,
        error
    } = useSuspenseQuery(getTransferMessagesByProviderPidOptions(api_gateway, transferProcessId))
    return {data, isLoading, isError, error}
}
 ...
 * */
export const getTransferMessageById = async (api_gateway: string, transferProcessId: UUID, messageId: UUID) => {
    const catalog: TransferMessage = await (
...
export const getTransferMessageByIdOptions = (api_gateway: string, transferProcessId: UUID, messageId: UUID) => queryOptions({
...
export const useGetTransferMessageById = (transferProcessId: UUID, messageId: UUID) => {
    ...
    const {
        ...
        isError,
        error
    } = useSuspenseQuery(getTransferMessageByIdOptions(api_gateway, transferProcessId, messageId))
    return {data, isLoading, isError, error}
}
...
export const getDataplaneProcessByIdOptions = (api_gateway: string, sessionId: UUID) => queryOptions({
...
export const useGetDataplaneProcessById = (transferProcessId: UUID) => {
    ...
    const {
        ...
        isError,
        error
    } = useSuspenseQuery(getDataplaneProcessByIdOptions(api_gateway, transferProcessId))
    return {data, isLoading, isError, error}
}