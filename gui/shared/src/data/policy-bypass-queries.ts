 ...
 * */
export const getBypassPoliciesByDatasetId = async (api_gateway: string, provider_id: UUID, datasetId: UUID) => {
...
export const getBypassPoliciesByDatasetIdOptions = (api_gateway: string, provider_id: UUID, datasetId: UUID) => queryOptions({
...
export const useGetBypassPoliciesByDatasetId = (provider_id: UUID, datasetId: UUID) => {
    ...
    const {
        ...
        isError,
        error
    } = useSuspenseQuery(getBypassPoliciesByDatasetIdOptions(api_gateway, provider_id, datasetId))
