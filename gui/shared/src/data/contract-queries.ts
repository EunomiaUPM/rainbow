...
export const getContractNegotiationProcessesOptions = (api_gateway: string) => queryOptions({
...
export const useGetContractNegotiationProcesses = () => {
    ...
    const {data, isLoading, isError, error} = useSuspenseQuery(getContractNegotiationProcessesOptions(api_gateway))
 ...
 * */
export const getContractNegotiationProcessesByCNID = async (api_gateway: string, contractNegotiationProcess: UUID) => {
...
export const getContractNegotiationProcessesByCNIDOptions = (api_gateway: string, contractNegotiationProcess: UUID) => queryOptions({
...
export const useGetContractNegotiationProcessesByCNID = (contractNegotiationProcess: UUID) => {
    ...
    const {
        ...
        isError,
        error
    } = useSuspenseQuery(getContractNegotiationProcessesByCNIDOptions(api_gateway, contractNegotiationProcess))
    return {data, isLoading, isError, error}
}
 ...
 * */
export const getContractNegotiationMessagesByCNID = async (api_gateway: string, contractNegotiationProcess: UUID) => {
    const cnMessages: CNMessage[] = await (
        await fetch(api_gateway + `/contract-negotiation/processes/${contractNegotiationProcess}/messages`)
    ).json();
    return cnMessages;
}

export const getContractNegotiationMessagesByCNIDOptions = (api_gateway: string, contractNegotiationProcess: UUID) => queryOptions({
...
export const useGetContractNegotiationMessagesByCNID = (contractNegotiationProcess: UUID) => {
    ...
    const {
        ...
        isError,
        error
    } = useSuspenseQuery(getContractNegotiationMessagesByCNIDOptions(api_gateway, contractNegotiationProcess))
    return {data, isLoading, isError, error}
}
 ...
 * */
export const getContractNegotiationMessageById = async (api_gateway: string, contractNegotiationMessage: UUID) => {
    const cnMessage: CNOffer = await (
        await fetch(api_gateway + `/contract-negotiation/messages/${contractNegotiationMessage}`)
    ).json();
    return cnMessage;
}
export const getContractNegotiationMessageByIdOptions = (api_gateway: string, contractNegotiationMessage: UUID) => queryOptions({
...
export const useGetContractNegotiationMessageById = (contractNegotiationMessage: UUID) => {
    ...
    const {
        ...
        isError,
        error
    } = useSuspenseQuery(getContractNegotiationMessageByIdOptions(api_gateway, contractNegotiationMessage))
    return {data, isLoading, isError, error}
}
 ...
 * */
export const getContractNegotiationOfferByCNMessageId = async (api_gateway: string, contractNegotiationMessage: UUID) => {
    const response = await fetch(api_gateway + `/contract-negotiation/messages/${contractNegotiationMessage}/offer`);
...
export const getContractNegotiationOfferByCNMessageIdOptions = (api_gateway: string, contractNegotiationMessage: UUID) => queryOptions({
    queryKey: ["CONTRACT_NEGOTIATION_OFFER_BY_MESSAGE_ID", contractNegotiationMessage],
    queryFn: () => getContractNegotiationOfferByCNMessageId(api_gateway, contractNegotiationMessage),
    enabled: !!contractNegotiationMessage,
...
export const useGetContractNegotiationOfferByCNMessageId = (contractNegotiationMessage: UUID) => {
    ...
    const {
        ...
        isError,
        error
    } = useQuery(getContractNegotiationOfferByCNMessageIdOptions(api_gateway, contractNegotiationMessage))
    return {data, isLoading, isError, error}
}
 ...
 * */
export const getAgreementByCNMessageId = async (api_gateway: string, contractNegotiationMessage: UUID) => {
    const response = await fetch(api_gateway + `/contract-negotiation/messages/${contractNegotiationMessage}/agreement`)
    if (response.status === 404) {
...
export const getAgreementByCNMessageIdOptions = (api_gateway: string, contractNegotiationMessage: UUID) => queryOptions({
...
export const useGetAgreementByCNMessageId = (contractNegotiationMessage: UUID) => {
    ...
    const {
        ...
        isError,
        error
    } = useQuery(getAgreementByCNMessageIdOptions(api_gateway, contractNegotiationMessage))
    return {data, isLoading, isError, error}
}