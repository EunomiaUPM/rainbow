...
export const getCatalogs = async (api_gateway: string) => {
    const catalogs: Catalog = await (
        await fetch(api_gateway + "/catalogs")
    ).json();
    return catalogs;
}

export const getCatalogsOptions = (api_gateway: string) => queryOptions({
    queryKey: ["CATALOGS"],
...
export const getCatalogsById = async (api_gateway: string, catalogId: UUID) => {
    const catalog: Catalog = await (
        await fetch(api_gateway + `/catalogs/${catalogId}`)
    ).json();
    return catalog;
}

export const getCatalogsByIdOptions = (api_gateway: string, catalogId: UUID) => queryOptions({
...
export const useGetCatalogsById = (catalogId: UUID) => {
    const {api_gateway} = useContext<GlobalInfoContextType>(GlobalInfoContext);
    const {data, isLoading, isError, error} = useSuspenseQuery(getCatalogsByIdOptions(api_gateway, catalogId))
    return {data, isLoading, isError, error}
}
...
export const getDatasetsByCatalogIdOptions = (api_gateway: string, catalogId: UUID) => queryOptions({
...
export const useGetDatasetsByCatalogId = (catalogId: UUID) => {
    ...
    const {
        ...
        isError,
        error
    } = useSuspenseQuery(getDatasetsByCatalogIdOptions(api_gateway, catalogId))
    return {data, isLoading, isError, error}
}
...
export const getDataServicesByCatalogIdOptions = (api_gateway: string, catalogId: UUID) => queryOptions({
...
export const useGetDataServicesByCatalogId = (catalogId: UUID) => {
    ...
    const {
        ...
        isError,
        error
    } = useSuspenseQuery(getDataServicesByCatalogIdOptions(api_gateway, catalogId))
    return {data, isLoading, isError, error}
}
...
export const getDatasetById = async (api_gateway: string, datasetId: UUID) => {
    const catalog: Dataset = await (
        await fetch(api_gateway + `/datasets/${datasetId}`)
    ).json();
    return catalog;
}

export const getDatasetByIdOptions = (api_gateway: string, datasetId: UUID) => queryOptions({
...
export const useGetDatasetById = (datasetId: UUID) => {
    const {api_gateway} = useContext<GlobalInfoContextType>(GlobalInfoContext);
    const {data, isLoading, isError, error} = useSuspenseQuery(getDatasetByIdOptions(api_gateway, datasetId))
    return {data, isLoading, isError, error}
}
...
export const getDistributionsByDatasetIdOptions = (api_gateway: string, datasetId: UUID) => queryOptions({
...
export const useGetDistributionsByDatasetId = (datasetId: UUID) => {
    ...
    const {
        ...
        isError,
        error
    } = useSuspenseQuery(getDistributionsByDatasetIdOptions(api_gateway, datasetId))
    return {data, isLoading, isError, error}
}
...
export const getDataServiceByIdOptions = (api_gateway: string, dataServiceId: UUID) => queryOptions({
...
export const useGetDataServiceById = (dataServiceId: UUID) => {
    ...
    const {
        ...
        isError,
        error
    } = useSuspenseQuery(getDataServiceByIdOptions(api_gateway, dataServiceId))
    return {data, isLoading, isError, error}
}
