...
export const getBypassCatalogsOptions = (api_gateway: string, provider_id: UUID) => queryOptions({
 ...
 * */
export const getBypassCatalogsById = async (api_gateway: string, provider_id: UUID, catalogId: UUID) => {
...
export const getBypassCatalogsByIdOptions = (api_gateway: string, provider_id: UUID, catalogId: UUID) => queryOptions({
...
export const useGetBypassCatalogsById = (provider_id: UUID, catalogId: UUID) => {
    ...
    const {
        ...
        isError,
        error
    } = useSuspenseQuery(getBypassCatalogsByIdOptions(api_gateway, provider_id, catalogId))
    return {data, isLoading, isError, error}
}
 ...
 * */
export const getBypassDatasetsByCatalogId = async (api_gateway: string, provider_id: UUID, catalogId: UUID) => {
...
export const getBypassDatasetsByCatalogIdOptions = (api_gateway: string, provider_id: UUID, catalogId: UUID) => queryOptions({
...
export const useGetBypassDatasetsByCatalogId = (provider_id: UUID, catalogId: UUID) => {
    ...
    const {
        ...
        isError,
        error
    } = useSuspenseQuery(getBypassDatasetsByCatalogIdOptions(api_gateway, provider_id, catalogId))
    return {data, isLoading, isError, error}
}
 ...
 * */
export const getBypassDataServicesByCatalogId = async (api_gateway: string, provider_id: UUID, catalogId: UUID) => {
...
export const getBypassDataServicesByCatalogIdOptions = (api_gateway: string, provider_id: UUID, catalogId: UUID) => queryOptions({
...
export const useGetBypassDataServicesByCatalogId = (provider_id: UUID, catalogId: UUID) => {
    ...
    const {
        ...
        isError,
        error
    } = useSuspenseQuery(getBypassDataServicesByCatalogIdOptions(api_gateway, provider_id, catalogId))
    return {data, isLoading, isError, error}
}
 ...
 * */
export const getBypassDatasetById = async (api_gateway: string, provider_id: UUID, datasetId: UUID) => {
    const catalog: Dataset = await (
...
export const getBypassDatasetByIdOptions = (api_gateway: string, provider_id: UUID, datasetId: UUID) => queryOptions({
...
export const useGetBypassDatasetById = (provider_id: UUID, datasetId: UUID) => {
    ...
    const {
        ...
        isError,
        error
    } = useSuspenseQuery(getBypassDatasetByIdOptions(api_gateway, provider_id, datasetId))
    return {data, isLoading, isError, error}
}
 ...
 * */
export const getBypassDistributionsByDatasetId = async (api_gateway: string, provider_id: UUID, datasetId: UUID) => {
...
export const getBypassDistributionsByDatasetIdOptions = (api_gateway: string, provider_id: UUID, datasetId: UUID) => queryOptions({
...
export const useGetBypassDistributionsByDatasetId = (provider_id: UUID, datasetId: UUID) => {
    ...
    const {
        ...
        isError,
        error
    } = useSuspenseQuery(getBypassDistributionsByDatasetIdOptions(api_gateway, provider_id, datasetId))
    return {data, isLoading, isError, error}
}
 ...
 * */
export const getBypassDataServiceById = async (api_gateway: string, provider_id: UUID, dataServiceId: UUID) => {
    const catalog: DataService = await (
...
export const getBypassDataServiceByIdOptions = (api_gateway: string, provider_id: UUID, dataServiceId: UUID) => queryOptions({
...
export const useGetBypassDataServiceById = (provider_id: UUID, dataServiceId: UUID) => {
    ...
    const {
        ...
        isError,
        error
    } = useSuspenseQuery(getBypassDataServiceByIdOptions(api_gateway, provider_id, dataServiceId))
    return {data, isLoading, isError, error}
}
