...
export const getDatahubBypassCatalogsOptions = (api_gateway: string, provider_id: UUID) => queryOptions({
...
export const useGetDatahubBypassCatalogs = (provider_id: UUID) => {
    ...
    const {
        ...
        isError,
        error
    } = useSuspenseQuery(getDatahubBypassCatalogsOptions(api_gateway, provider_id))
 ...
 * */
export const getDatahubBypassDatasetsByCatalogId = async (api_gateway: string, provider_id: UUID, catalogId: UUID) => {
    const catalog: Dataset[] = await (
        await fetch(api_gateway + `/catalog-bypass/${provider_id}/datahub/domains/${catalogId}/datasets`)
    ).json();
    return catalog;
}

export const getDatahubBypassDatasetsByCatalogIdOptions = (api_gateway: string, provider_id: UUID, catalogId: UUID) => queryOptions({
...
export const useGetDatahubBypassDatasetsByCatalogId = (provider_id: UUID, catalogId: UUID) => {
    ...
    const {
        ...
        isError,
        error
    } = useSuspenseQuery(getDatahubBypassDatasetsByCatalogIdOptions(api_gateway, provider_id, catalogId))
    return {data, isLoading, isError, error}
}
 ...
 * */
export const getDatahubBypassDatasetById = async (api_gateway: string, provider_id: UUID, datasetId: UUID) => {
    const catalog: Dataset = await (
        await fetch(api_gateway + `/catalog-bypass/${provider_id}/datahub/domains/datasets/${datasetId}`)
    ).json();
    return catalog;
}

export const getDatahubBypassDatasetByIdOptions = (api_gateway: string, provider_id: UUID, datasetId: UUID) => queryOptions({
...
export const useGetDatahubBypassDatasetById = (provider_id: UUID, datasetId: UUID) => {
    ...
    const {
        ...
        isError,
        error
    } = useSuspenseQuery(getDatahubBypassDatasetByIdOptions(api_gateway, provider_id, datasetId))
    return {data, isLoading, isError, error}
}
