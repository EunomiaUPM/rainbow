...
import type { OdrlPolicyInfoProfile } from './odrlPolicyInfoProfile';

export interface OdrlPolicyInfo {
  profile?: OdrlPolicyInfoProfile;
  permission?: OdrlPermission[];
  obligation?: OdrlObligation[];
  prohibition?: OdrlObligation[];
}
