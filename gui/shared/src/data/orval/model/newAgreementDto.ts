 ...
 */
import type { NewAgreementDtoAgreementContent } from './newAgreementDtoAgreementContent';

export interface NewAgreementDto {
  id?: string;
  negotiationAgentProcessId: string;
  negotiationAgentMessageId: string;
  consumerParticipantId: string;
  providerParticipantId: string;
  agreementContent: NewAgreementDtoAgreementContent;
  target: string;
}
