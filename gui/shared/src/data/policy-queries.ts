...
export const getPoliciesByDatasetIdOptions = (api_gateway: string, datasetId: UUID) => queryOptions({
...
export const useGetPoliciesByDatasetId = (datasetId: UUID) => {
    ...
    const {
        ...
        isError,
        error
    } = useSuspenseQuery(getPoliciesByDatasetIdOptions(api_gateway, datasetId))
