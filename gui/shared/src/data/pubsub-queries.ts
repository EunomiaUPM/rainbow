...
export const getSubscriptions = async (api_gateway: string) => {
  const catalogs: Subscription[] = await (await fetch(api_gateway + "/subscriptions")).json();
  return catalogs;
};

export const getSubscriptionsOptions = (api_gateway: string) =>
  queryOptions({
...
export const getSubscriptionByIdOptions = (api_gateway: string, subscriptionId: UUID) =>
  queryOptions({
 ...
 * */
export const getSubscriptionByCallbackAddress = async (
  api_gateway: string,
  callbackUrl: string,
) => {
  const catalogs: Subscription = await (
...
export const getSubscriptionByCallbackAddressOptions = (api_gateway: string, callbackUrl: string) =>
  queryOptions({
...
export const getNotificationsBySubscriptionIdOptions = (
  api_gateway: string,
...
export const getPendingNotificationsBySubscriptionIdOptions = (
  api_gateway: string,
  subscriptionId: string,
) =>
  queryOptions({
