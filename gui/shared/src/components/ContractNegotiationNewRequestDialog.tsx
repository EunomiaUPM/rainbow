...
import {usePostContractNegotiationRPCRequest} from "@/data/contract-mutations.ts";

export const ContractNegotiationNewRequestDialog = ({policy, catalogId, datasetId, participantId}: {
    policy: OdrlOffer,
    catalogId: UUID,
    datasetId: UUID,
