...
import { TransferMessageDto } from "../data/orval/model";
...
/**
 * Component for displaying a single Transfer Process message with chat bubble design.
 */
    ...
    >
      ...
      >
        ...
        <div className="flex flex-wrap gap-2 text-[11px] text-muted-foreground font-mono">
          ...
          {message.transferAgentProcessId && (
            <span>• Process: {formatUrn(message.transferAgentProcessId, true)}</span>
          )}
        </div>
