...
import {PolicyWrapperShow} from "@/components/PolicyWrapperShow.tsx";
        ...
        <DialogContent className="w-[70dvw] sm:max-w-fit">
            ...
            <Form {...form}>
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    {offer && <div className="grid grid-cols-2 gap-4">
                        <PolicyWrapperShow policy={offer.offer_content}/>
                        <PolicyWrapperEdit policy={offer.offer_content} onSubmit={onSubmit}/>
                    </div>
                    }
                    ...
                    <DialogFooter className="[&>*]:w-full">
                        ...
                        <Button variant="outline" type="submit">Request</Button>
                    </DialogFooter>
                </form>
            </Form>
        </DialogContent>
