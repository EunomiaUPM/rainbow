...
export const PolicyWrapperEdit = ({policy, onSubmit}: { policy: OdrlOffer, onSubmit: any }) => {
                            ...
                            <AccordionContent className="relative">
                                ...
                                {newPolicy.permission.map((permission, i) => (<div>
                                    <div className="policy-item-create">
                                        ...
                                        <Select
                                            onValueChange={(value: string) => fieldValueChangeHandler("permission", i, value)}
                                                        ...
                                                        <div className="flex flex-col">
                                                            ...
                                                            <SelectContent>
                                                                {leftOperands.map(leftOperand => (
                                                                    <SelectItem
                                                                        value={leftOperand}>{leftOperand}</SelectItem>))}
                                                            </SelectContent>
                                                        </div>
                                                    </Select>
                                                    <Select
                                                        onValueChange={(value: string) => operandValueChangeHandler("permission", i, j, "operator", value)}
                                                        ...
                                                        <div className="flex flex-col">
                                                            ...
                                                            <SelectContent>
                                                                {operators.map(operator => (
                                                                    <SelectItem
                                                                        value={operator}>{operator}</SelectItem>))}
                                                            </SelectContent>
                                                        </div>
                                                    </Select>
                                                    <div className="flex flex-col">
                            ...
                            <AccordionContent className="relative">
                                ...
                                {newPolicy.obligation.map((obligation, i) => (<div>
                                    <div className="policy-item-create">
                                        ...
                                        <Select
                                            onValueChange={(value: string) => fieldValueChangeHandler("obligation", i, value)}
                                        ...
                                        {obligation.constraint.map((constraint, j) => (
                                            <div className="flex flex-col gap-2">
                                                <div className="constraint-create flex gap-3">
                                                    ...
                                                    <Select
                                                        onValueChange={(value: string) => operandValueChangeHandler("obligation", i, j, "operator", value)}
                                                        value={constraint.operator}
                                                    >
                                                        <div className="flex flex-col">
                                                            <p className="text-xs text-gray-400 mb-1">
                            ...
                            <AccordionContent className="relative">
                                ...
                                {newPolicy.prohibition.map((prohibition, i) => (<div>
                                    <div className="policy-item-create">
                                        ...
                                        <Select
                                            onValueChange={(value: string) => fieldValueChangeHandler("prohibition", i, value)}
                                        ...
                                        {prohibition.constraint.map((constraint, j) => (
                                            <div className="flex flex-col gap-2">
                                                <div className="constraint-create flex gap-3">
                                                    ...
                                                    <Select
                                                        onValueChange={(value: string) => operandValueChangeHandler("prohibition", i, j, "operator", value)}
                                                        value={constraint.operator}
                                                    >
                                                        <div className="flex flex-col">
                                                            <p className="text-xs text-gray-400 mb-1">
