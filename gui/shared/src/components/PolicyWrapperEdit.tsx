                                                            ...
                                                            <div className="constraint-create flex gap-3 items-end">
                                                                ...
                                                                >
                                                                    <div className="flex flex-col">
                                                                        <p className="text-xs text-gray-400 mb-1">Left
                                                                            Operand:</p>
                                                                ...
                                                                <div className="flex flex-col">
                                                                    <p className="text-xs text-gray-400 mb-1">Right
                                                                        Operand:</p>
                                                                    <Input
                                                        ...
                                                        <SelectContent>
                                                            {odrlActions.map((odrlAction) => (
                                                                <SelectItem value={odrlAction}
                                                                            key={odrlAction}>{odrlAction}</SelectItem>
                                                            ))}
                                                        </SelectContent>
                                                    </Select>
                                                    <div className="h-6"></div>
                                                                ...
                                                                >
                                                                    <div className="flex flex-col">
                                                                        ...
                                                                        <SelectContent>
                                                                            {leftOperands.map((leftOperand) => (
                                                                                <SelectItem value={leftOperand}
                                                                                            key={leftOperand}>{leftOperand}</SelectItem>
                                                                            ))}
                                                                        </SelectContent>
                                                                    </div>
                                                                </Select>
                                                                ...
                                                                >
                                                                    <div className="flex flex-col">
                                                                        ...
                                                                        <SelectContent>
                                                                            {operators.map((operator) => (
                                                                                <SelectItem value={operator}
                                                                                            key={operator}>{operator}</SelectItem>
                                                                            ))}
                                                                        </SelectContent>
                                                                    </div>
                                                                </Select>
