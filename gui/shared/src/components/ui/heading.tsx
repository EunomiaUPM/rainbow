...
const Heading = ({ level = "h1", children, className = "" }) => {
  ...
  const baseClasses = "text-text  text-balance";
  const sizeClasses = {
    h1: "text-36 sm:text-40 mb-6 font-medium font-title",
    h2: "text-32 sm:text-36 mb-4 font-medium",
    h3: "text-28 sm:text-32 mb-4 font-medium",
    h4: "text-24 sm:text-28 mb-2 font-medium font-display", // lo de poner la clase de la tipo no funciona aqui
