...
const List = ({className, children, ...props}: { className?: string, children: React.ReactNode, props?: any }) => {
    return (
        <ul
            className={cn(
...
const ListItem = ({className, children, ...props}: { className?: string, children: React.ReactNode, props?: any }) => {
    return (
        <li
            className="h-fit py-1.5 place-content-center flex flex-row justify-start items-center gap-4 border-b border-white/20 last:border-0 items-center"
            {...props}>
            {children}
        </li>
    )
...
const ListItemKey = ({className, children, ...props}: {
    className?: string,
