...
export const PolicyWrapperShow = ({policy, datasetId, catalogId, participant, datasetName}: {
    policy: OdrlOffer;
    datasetId: any;
    catalogId: any;
    participant: any;
    ...
    return (
        <div className="">
            <List
                className="h-full flex flex-col items-start justify-start border border-white/30 bg-white/10 px-4 pb-4 pt-2 rounded-md ">
