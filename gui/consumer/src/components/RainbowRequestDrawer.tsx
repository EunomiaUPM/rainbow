...
import {useGetBypassDatasetById} from "shared/src/data/catalog-bypass-queries.ts";
...
export const RainbowRequestDrawer = ({
                                       catalogId,
                                       datasetId,
                                       participantId,
                                       closeDrawer,
  ...
  const {data: datasetInfo} = useGetBypassDatasetById(participantId, datasetId);
