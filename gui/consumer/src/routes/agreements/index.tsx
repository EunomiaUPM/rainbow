...
import { TransferProcessRequestDialog } from "shared/src/components/TransferProcessRequestDialog.tsx";
          ...
          <TableBody>
            {agreements.map((agreement) => (
              <TableRow key={agreement.agreement_id.slice(9, 20)}>
                ...
                <TableCell>
                  <Badge variant={"status"} state={agreement.active ? "ACTIVE" : "INACTIVE"}>
                ...
                <TableCell>
                  <Dialog>
                    ...
                    <TransferProcessRequestDialog agreement={agreement} />
                  </Dialog>
                </TableCell>
                <TableCell>
                  <Link
