...
import { Tabs, TabsList, TabsTrigger,   TabsContent, } from "shared/src/components/ui/tabs.tsx";
import {
  Drawer,
  DrawerBody,
  DrawerClose,
...
function RouteComponent() {
  let addSpacesFromat = (text: string) => {
    ...
    <div className="space-y-4">
      {/* <Tabs defaultValue="data-control" className="w-[400px]">
        ...
        <TabsContent value="data-plane">
          ...
          <div className="mb-4">{JSON.stringify(dataPlane)}</div>
        </TabsContent>
        ...
        <TabsContent value="data-control">
          ...
          {transferMessages.map((transferMessage) => (
            <div className="my-4" key={transferMessage.id}>
              <div
