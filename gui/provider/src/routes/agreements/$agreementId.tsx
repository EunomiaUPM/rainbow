            ...
            <div>
                ...
                <List>
                    ...
                    <ListItem>
                        ...
                        <TableCell> <Badge
                            variant="info">{agreement.consumer_participant_id.slice(9, 29) + "[...]"} </Badge></TableCell>
                    </ListItem>
                    <ListItem>
                        <ListItemKey>Provider Participant Id</ListItemKey>
                        <TableCell> <Badge
                            variant="info">{agreement.provider_participant_id.slice(9, 29) + "[...]"} </Badge></TableCell>
                    </ListItem>
                    <ListItem>
                        <ListItemKey>Status</ListItemKey>
                        <TableCell> <Badge variant="status"
                                           state={agreement.active ? "started" : "pause"}>{agreement.active ? "ACTIVE" : "INACTIVE"} </Badge></TableCell>
                    </ListItem>
                    <ListItem>
