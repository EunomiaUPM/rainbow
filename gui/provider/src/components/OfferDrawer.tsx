...
import {Form, FormControl, FormField, FormItem, FormLabel, FormMessage,} from "shared/src/components/ui/form.tsx";
...
export const OfferDrawer = ({catalogId, datasetId, closeDrawer,}: {
    catalogId: string;
    datasetId: string;
