...
pub struct MateConsumerApplicationConfig {
...
impl Default for MateConsumerApplicationConfig {
    fn default() -> Self {
        MateConsumerApplicationConfig::from(ApplicationConsumerConfig::default())
    }
}

impl ApplicationConsumerConfigTrait for MateConsumerApplicationConfig {
        ...
        Self: Sized,
    {
        ...
        MateConsumerApplicationConfig::from(app_config)
    }
}

impl From<ApplicationConsumerConfig> for MateConsumerApplicationConfig {
...
impl Into<ApplicationConsumerConfig> for MateConsumerApplicationConfig {
