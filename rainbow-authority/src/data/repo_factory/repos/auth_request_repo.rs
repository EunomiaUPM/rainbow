...
use crate::data::entities::auth_request::{Entity, Model, NewModel};
use crate::data::repo_factory::repos::GenericRepo;
use crate::data::repo_factory::traits::{AuthRequestRepoTrait, BasicRepoTrait};
...
#[async_trait]
impl BasicRepoTrait<Model, NewModel> for AuthRequestRepo {
