 ...
 *
 */
use crate::services::verifier::basic::config::BasicVerifierConfigTrait;
...
impl From<AuthorityApplicationConfig> for BasicVerifierConfig {
    fn from(config: AuthorityApplicationConfig) -> BasicVerifierConfig {
        BasicVerifierConfig { host: config.authority_host, is_local: config.is_local }
    }
}
