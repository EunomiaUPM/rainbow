 ...
 *
 */
use super::{WalletServiceConfig, WalletServiceConfigTrait, WalletServiceTrait};
...
use crate::types::oidc::WellKnownJwks;
...
impl WalletService {
    pub fn new(config: WalletServiceConfig, client: Arc<ClientService>) -> WalletService {
        WalletService {
