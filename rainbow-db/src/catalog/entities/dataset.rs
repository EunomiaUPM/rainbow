...
impl Related<super::dataset::Entity> for BelongsToCurrentVersion {
    fn to() -> RelationDef {
        Relation::CurrentVersion.def()
    }
}

impl Related<super::dataset::Entity> for BelongsToPreviousVersion {
    fn to() -> RelationDef {
        Relation::PreviousVersion.def()
    }
}

impl Related<super::dataset::Entity> for BelongsToReplaces {
    fn to() -> RelationDef {
        Relation::Replaces.def()
    }
}

impl Related<super::dataset::Entity> for BelongsToLast {
    fn to() -> RelationDef {
        Relation::Last.def()
    }
}

impl Related<super::dataset::Entity> for BelongsToFirst {
    fn to() -> RelationDef {
        Relation::First.def()
    }
}

impl Related<super::dataset::Entity> for BelongsToPrev {
    fn to() -> RelationDef {
        Relation::Prev.def()
    }
}
