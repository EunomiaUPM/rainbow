...
use crate::auth_provider::repo_factory::repos::{
    AuthInteractionProviderRepo, AuthRequestProviderRepo, AuthTokenRequirementsProviderRepo,
    AuthVerificationProviderRepo, BusinessMatesProviderRepo, MatesProviderRepo,
};
...
impl AuthProviderRepoForSql {
    pub fn create_repo(db_connection: DatabaseConnection) -> Self {
        Self {
            ...
            mates_repo: Arc::new(MatesProviderRepo::new(db_connection.clone())),
            business_mates_repo: Arc::new(BusinessMatesProviderRepo::new(db_connection)),
        }
    }
}

impl AuthRepoFactoryTrait for AuthProviderRepoForSql {
    ...
    fn business_mates_repo(&self) -> Arc<dyn BusinessMatesRepoTrait> {
