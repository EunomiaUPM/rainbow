 ...
 *
 */
use crate::auth_provider::entities::mates::{Column, Entity, Model, NewModel};
use crate::auth_provider::repo_factory::repos::GenericRepo;
use crate::auth_provider::repo_factory::traits::{BasicRepoTrait, MatesRepoTrait};
use axum::async_trait;
use sea_orm::{ColumnTrait, DatabaseConnection, EntityTrait, QueryFilter};

#[derive(Clone)]
pub struct MatesProviderRepo {
    inner: GenericRepo<Entity, NewModel>,
}

impl MatesProviderRepo {
...
#[async_trait]
impl BasicRepoTrait<Model, NewModel> for MatesProviderRepo {
...
#[async_trait]
impl MatesRepoTrait for MatesProviderRepo {
