...
use crate::auth_provider::repo_factory::traits::{BasicRepoTrait, BusinessMatesRepoTrait, MatesRepoTrait};
...
#[async_trait]
impl BasicRepoTrait<Model, NewModel> for BusinessMatesProviderRepo {
