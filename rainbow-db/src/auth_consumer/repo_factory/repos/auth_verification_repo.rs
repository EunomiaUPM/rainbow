...
use crate::auth_consumer::entities::auth_verification::{Entity, Model, NewModel};
use crate::auth_consumer::repo_factory::repos::GenericRepo;
use crate::auth_consumer::repo_factory::traits::{AuthVerificationRepoTrait, BasicRepoTrait};
use sea_orm::DatabaseConnection;

#[derive(Clone)]
pub struct AuthVerificationConsumerRepo {
    inner: GenericRepo<Entity, NewModel>,
}

impl AuthVerificationConsumerRepo {
...
#[async_trait]
impl BasicRepoTrait<Model, NewModel> for AuthVerificationConsumerRepo {
...
#[async_trait]
impl AuthVerificationRepoTrait for AuthVerificationConsumerRepo {}
