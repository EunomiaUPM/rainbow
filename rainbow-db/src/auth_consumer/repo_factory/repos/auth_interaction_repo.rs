...
use crate::auth_consumer::entities::auth_interaction::{Entity, Model, NewModel};
use crate::auth_consumer::repo_factory::repos::GenericRepo;
use crate::auth_consumer::repo_factory::traits::{AuthInteractionRepoTrait, BasicRepoTrait};
use sea_orm::DatabaseConnection;

#[derive(Clone)]
pub struct AuthInteractionConsumerRepo {
    inner: GenericRepo<Entity, NewModel>,
}

impl AuthInteractionConsumerRepo {
...
#[async_trait]
impl BasicRepoTrait<Model, NewModel> for AuthInteractionConsumerRepo {
...
#[async_trait]
impl AuthInteractionRepoTrait for AuthInteractionConsumerRepo {}
