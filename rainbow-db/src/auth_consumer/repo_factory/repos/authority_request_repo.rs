...
use crate::auth_consumer::entities::authority_request::{Entity, Model, NewModel};
use crate::auth_consumer::repo_factory::traits::AuthorityRequestRepoTrait;
use crate::common::{BasicRepoTrait, GenericRepo};
use axum::async_trait;
use sea_orm::DatabaseConnection;

#[derive(Clone)]
pub struct AuthorityRequestConsumerRepo {
    inner: GenericRepo<Entity, NewModel>,
}

impl AuthorityRequestConsumerRepo {
...
#[async_trait]
impl BasicRepoTrait<Model, NewModel> for AuthorityRequestConsumerRepo {
...
#[async_trait]
impl AuthorityRequestRepoTrait for AuthorityRequestConsumerRepo {}
