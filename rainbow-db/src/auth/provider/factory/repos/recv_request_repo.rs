...
use crate::auth::provider::entities::recv_request::{Entity, Model, NewModel};
use super::super::traits::RecvRequestTrait;
...
#[async_trait]
impl BasicRepoTrait<Model, NewModel> for RecvRequestRepo {
