...
use crate::auth::provider::entities::recv_token_requirements::{Entity, Model};
use super::super::traits::RecvTokenRequirementsTrait;
use crate::common::{BasicRepoTrait, GenericRepo};
use axum::async_trait;
use sea_orm::DatabaseConnection;

#[derive(Clone)]
pub struct RecvTokenRequirementsRepo {
    inner: GenericRepo<Entity, Model>,
}

impl RecvTokenRequirementsRepo {
...
#[async_trait]
impl BasicRepoTrait<Model, Model> for RecvTokenRequirementsRepo {
...
#[async_trait]
impl RecvTokenRequirementsTrait for RecvTokenRequirementsRepo {}
