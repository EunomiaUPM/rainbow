...
use crate::auth::provider::entities::auth_interaction::{Column, Entity, Model, NewModel};
use super::super::traits::AuthInteractionRepoTrait;
use crate::common::{BasicRepoTrait, GenericRepo};
use axum::async_trait;
use sea_orm::{ColumnTrait, DatabaseConnection, EntityTrait, QueryFilter};

#[derive(Clone)]
pub struct AuthInteractionProviderRepo {
    inner: GenericRepo<Entity, NewModel>,
}

impl AuthInteractionProviderRepo {
...
#[async_trait]
impl BasicRepoTrait<Model, NewModel> for AuthInteractionProviderRepo {
...
#[async_trait]
impl AuthInteractionRepoTrait for AuthInteractionProviderRepo {
