...
use crate::auth::common::entities::req_vc::{Entity, Model, NewModel};
use super::super::traits::ReqVcTrait;
...
#[async_trait]
impl BasicRepoTrait<Model, NewModel> for VcRequestRepo {
...
#[async_trait]
impl ReqVcTrait for VcRequestRepo {}
