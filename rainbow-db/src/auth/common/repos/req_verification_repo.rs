...
use crate::auth::common::entities::req_verification::{Entity, Model, NewModel};
use crate::auth::common::traits::req_verification_trait::ReqVerificationTrait;
...
#[async_trait]
impl BasicRepoTrait<Model, NewModel> for ReqVerificationRepo {
