...
use crate::auth::common::entities::authority_request::{Entity, Model, NewModel};
use super::super::traits::AuthorityRequestRepoTrait;
use crate::common::{BasicRepoTrait, GenericRepo};
use axum::async_trait;
use sea_orm::DatabaseConnection;

#[derive(Clone)]
pub struct AuthorityRequestRepo {
    inner: GenericRepo<Entity, NewModel>,
}

impl AuthorityRequestRepo {
...
#[async_trait]
impl BasicRepoTrait<Model, NewModel> for AuthorityRequestRepo {
...
#[async_trait]
impl AuthorityRequestRepoTrait for AuthorityRequestRepo {}
