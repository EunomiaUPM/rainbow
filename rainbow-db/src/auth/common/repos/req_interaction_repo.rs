 ...
 *
 */
use crate::auth::common::entities::req_interaction::{Entity, Model, NewModel};
use crate::auth::common::traits::ReqInteractionTrait;
...
#[async_trait]
impl BasicRepoTrait<Model, NewModel> for ReqInteractionRepo {
