...
use crate::auth::consumer::entities::req_request::{Entity, Model, NewModel};
use super::super::traits::ReqRequestTrait;
...
#[async_trait]
impl BasicRepoTrait<Model, NewModel> for ReqRequestRepo {
